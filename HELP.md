...
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/3.5.12/reference/data/nosql.html#data.nosql.mongodb)
...
* [Spring Web Services](https://docs.spring.io/spring-boot/3.5.12/reference/io/webservices.html)
